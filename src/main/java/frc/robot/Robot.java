...
public class Robot extends TimedRobot {
  ...
  public static Claw clawPenumatics = new Claw();
 ...
 // public static LimitSwitch spitter = new LimitSwitch();
  ...
  public static NetworkTable table = NetworkTableInstance.getDefault().getTable("VisionTable");
  public static NetworkTableEntry centreX= table.getEntry("center"); // PI NETWORKTABLES
  public static double centerX = centreX.getDouble(0.0);
  ...
  public void robotInit() {
    ...
    //starting vision server from pi
  ...
  */
  ...
  public void teleopPeriodic() {
    ...
    double distance2 = testEncoder.getDistance();
